    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="py-16 md:py-20 bg-white overflow-hidden">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-forest-800 mb-4 md:mb-6 animate-fade-in">
            Follow Our Adventure
          </h2>
          <p className="text-lg md:text-xl text-gray-600 mb-6 md:mb-8 max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-8 max-w-4xl mx-auto">
            ...
            <a
              ...
              className="bg-sage-50 rounded-2xl p-6 md:p-8 lg:p-12 flex-1 max-w-md mx-auto animate-scale-in hover:bg-sage-100 transition-colors duration-300 block"
              style={{ animationDelay: '0.4s' }}
            >
              <div className="text-sage-400 mb-3 md:mb-4">
              ...
              <h3 className="text-base md:text-lg font-semibold text-forest-800 mb-2">@CampingPrincipata</h3>
              <p className="text-gray-600 text-xs md:text-sm leading-relaxed">
                Follow us for daily inspiration and guest adventures.
              </p>
            </a>

            {/* Facebook Section - Clickable (add your Facebook URL here) */}
            <a
              href="#" // Replace this with your Facebook page URL when ready
              target="_blank"
              rel="noopener noreferrer"
              className="bg-blue-50 rounded-2xl p-6 md:p-8 lg:p-12 flex-1 max-w-md mx-auto animate-scale-in hover:bg-blue-100 transition-colors duration-300 block"
              style={{ animationDelay: '0.6s' }}
            >
              <div className="text-blue-400 mb-3 md:mb-4">
                <Facebook size={48} className="w-12 h-12 md:w-16 md:h-16 mx-auto" />
              </div>
              <h3 className="text-base md:text-lg font-semibold text-forest-800 mb-2">Camping Principata</h3>
              <p className="text-gray-600 text-xs md:text-sm leading-relaxed">
