      ...
      <section className="py-16 md:py-20 bg-white overflow-hidden">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-8 max-w-4xl mx-auto">
            <div className="bg-sage-50 rounded-2xl p-6 md:p-8 lg:p-12 flex-1 max-w-md mx-auto animate-scale-in" style={{ animationDelay: '0.4s' }}>
            ...
            <div className="bg-blue-50 rounded-2xl p-6 md:p-8 lg:p-12 flex-1 max-w-md mx-auto animate-scale-in" style={{ animationDelay: '0.6s' }}>
